...
a:link {text-decoration: none; color: #e64d00;}
a:visited {text-decoration: none; color: #e64d00;}
a:active {text-decoration: none; color: #e64d00;}
...
<script language="javascript">
	$(function() {
		...
		$("#later").click(function() {
			$("#content").load("../pan/Re.do?y=<%=laterYear%>&m=<%=laterMonth%>");
		});

		$("#last").click(function() {
			$("#content").load("../pan/Re.do?y=<%=nextYear%>&m=<%=nextMonth%>");
		});
...
<div class="content" id="content">
	...
	<form name="step2Form" method="post" action="../pan/Re.do">
		<input type="hidden" name="step" value="two" /> <input type="hidden"
			name="chooseDate" /> <input type="hidden" name="chooseRno" />
	</form>
	<table class="table" style="border-color: #999;" cellspacing="1" width="80%" height="80%" align="center">
		<thead>
			<tr>
				<td colspan="7"><%="오늘은 - " + nowYear + "년 " + nowMonth + "월 " + nowDate + "일"%>
					<center id="calTitle" >
						<a href="#" id="later">◀</a>
						<%=year + "년 " + month + "월"%>
						<a href="#" id="last">▶</a>
			...
			<tr>
				...
				<td class="topLeft"
					...
					<div id="state2">
						...
						%>
						<font id="heart"><img src="../pan/Main/images/list-arrow.png" alt="" /></font><%=cLinkF + room.get(j).getRname() + usedRoom + cLinkB%>
						<br />
						<%
							}
						%>
