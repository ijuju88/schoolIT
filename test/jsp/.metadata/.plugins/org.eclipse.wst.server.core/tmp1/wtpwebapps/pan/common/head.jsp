					...
					<div class="container-fluid">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav">
								<li class="active"><a href="../Main/index.jsp" id="home1">Home <span
										class="sr-only">(current)</span></a></li>
								<li><a href="../Room/about.jsp" id="about">About</a></li>
								<li><a href="../Room/services.jsp" id="services">Services</a></li>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown" role="button" aria-haspopup="true"
									aria-expanded="false">Rooms <span class="caret"></span></a>
									<ul class="dropdown-menu">
										<li><a href="../Room/Room1.jsp" id="room1">Deluxe Rooms</a></li>
										<li><a href="../Room/Room2.jsp" id="room2">Sweet Rooms</a></li>
										<li><a href="../Room/Room3.jsp" id="room3">Korea Style Rooms</a></li>
									</ul></li>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
									data-toggle="dropdown" role="button" aria-haspopup="true"
									...
									<ul class="dropdown-menu">
										...
										<li><a href="../reservation/confirmBook.jsp" id="confirm">Confirm</a></li>

									</ul></li>
								<li><a href="../noticeboard/NoticeMainServlet?command=notice_list" id="Notice">Notice</a></li>
								<li><a href="../usedBoard/list.jsp" id="Qboard">Question</a></li>
								<li><a href="../board/BoardServlet?command=board_list" id="review">Review</a></li>


								<li>
								<jsp:include page="../clientmember/login.jsp"></jsp:include>
								</li>
							</ul>
						</div>
						<!-- /.navbar-collapse -->
