function memberReg(){
	document.location="../clientmember/MemberJoin.jsp";
}
...
function openConfirmid(mfrm){
	...
	url="../clientmember/confirmId.jsp?id=" + mfrm.id.value;
...
function openConfirmJumin(mfrm){
	...
	url="../clientmember/confirmJumin.jsp?jumin1=" + mfrm.jumin1.value + "&jumin2=" + mfrm.jumin2.value;
	open(url,"confirm","toolbar=no, location=no,status=no,menubar=no, scrollbars=no,resizable=no,width=300,height=200");
...
function openConfirmEmail(mfrm){
	...
	url="../clientmember/confirmEmail.jsp?email=" + mfrm.email.value;
	open(url,"confirm","toolbar=no, location=no,status=no,menubar=no, scrollbars=no,resizable=no,width=300,height=200");
