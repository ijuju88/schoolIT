...
if (pageNum == null) {
    ...
    String flag = request.getParameter("flag");
	   ...
	   if(flag.equals("search1")) {
		    sstring =  new String(request.getParameter("sstring1").getBytes("ISO-8859-1"),"UTF-8");
	   }
...
<table class="table" cellspacing="0" style="width: 80%;"><tr>
...
<td><a href="javascript:$('#content').load('../usedBoard/wirteForm.jsp');">
