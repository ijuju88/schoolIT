...
public class Company_registration extends JFrame {
	...
	public Company_registration() {
		...
		CRJBNew.setBounds(650, 35, 220, 27);
		CRpanel.add(CRJBNew);

		CRJBSave = new JButton("저장");
		CRJBSave.setBounds(650, 5, 220, 27);
		CRpanel.add(CRJBSave);

		CRJBSaveMod = new JButton("내용저장");
		CRJBSaveMod.setBounds(650, 5, 220, 27);
		CRpanel.add(CRJBSaveMod);

		CRJBMod = new JButton("수정");
		CRJBMod.setBounds(650, 65, 220, 27);
		CRpanel.add(CRJBMod);

		CRJBCel = new JButton("취소");
		CRJBCel.setBounds(650, 125, 220, 27);
		CRpanel.add(CRJBCel);

		CRJBDel = new JButton("삭제");
		CRJBDel.setBounds(650, 95, 220, 27);
		CRpanel.add(CRJBDel);

		CRExcel = new JButton("엑셀파일만들기");
		CRExcel.setEnabled(false);
		CRExcel.setBounds(650, 155, 220, 27);
		CRpanel.add(CRExcel);
		...
		getContentPane().setLayout(null);
		getContentPane().add(CRpanel);

		CRlb = new JLabel("저장눌려 직인을 찾습니다. 취소하셔도 저장은 됩니다만...");
		CRlb.setBounds(503, 183, 367, 18);
		CRpanel.add(CRlb);

		CRlb.setEnabled(false);

		JScrollPane scrollPane = new JScrollPane(CRtable);
		scrollPane.setLocation(0, 220);
		scrollPane.setSize(877, 233);
