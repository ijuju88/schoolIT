...
public class Tax_Bill extends JFrame {
	...
	public Tax_Bill() {
		...
		jbTax_Bill_Ent.addActionListener(new ActionListener() {
			...
			public void inputdb(String daynum, String daynum1, Object critem, Object aritem, JTextField jtCRname,
				...
				try {
					...
					String sql = "insert into Tax_Bill values(?,?,?,?,?,?,?,?,?)";
					String sql1 = "insert into Tax_Bill_key values(?,?,?,?,?,?,?,?,?)";
					...
					for (int row = 0; row < table.getRowCount(); row++) {
						...
						int Row7 = Integer.parseInt(String.valueOf(table.getValueAt(row, 6)));
						String Row8 = (String) table.getValueAt(row, 7);
		...
		jbTax_Bill_Cel.addActionListener(new ActionListener() {
